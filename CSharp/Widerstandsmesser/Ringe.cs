...
public class Ring
{
    ...
    public static readonly Ring Silber = new(Farben.Silber, null, null, 0.01, 10);
    public static readonly Ring Gold = new(Farben.Gold, null, null, 0.1, 5);
    public static readonly Ring Schwarz = new(Farben.Schwarz, 0, 0, 1, null);
    public static readonly Ring Braun = new(Farben.Braun, 0, 0, 10, 1);
    public static readonly Ring Rot = new(Farben.Rot, 2, 2, 100, 2);
    public static readonly Ring Orange = new(Farben.Orange, 3, 3, 1000, null);
    public static readonly Ring Gelb = new(Farben.Gelb, 4, 4, 10000, null);
    ...
    public static readonly Ring Weiß = new(Farben.Gold, 9, 9, 1000000000, null);
